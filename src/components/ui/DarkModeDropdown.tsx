...
const DarkModeDropdown = ({ setDropOpen }: { setDropOpen: Dispatch<SetStateAction<boolean>> }) => {
  ...
  return (
    <div
      className={`absolute right-0 -bottom-[90px] flex w-28 flex-col items-start justify-around gap-2 rounded-md border-none bg-white px-2 py-2 shadow-md shadow-gray-300 dark:border dark:border-gray-800 dark:bg-gray-950 dark:shadow-gray-800`}
    >
      <p
        onClick={() => {
      ...
      <div className='w-11/12 border-b -my-1 border-gray-100 dark:border-gray-800'></div>
      <p
        onClick={() => {
